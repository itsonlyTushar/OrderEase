  ...
  return (
    <div className="sm:flex items-center sm:justify-evenly grid grid-cols-1 gap-10 text-blackBg">
      <div>
        ...
        <div className="border cursor-pointer transition-all hover:bg-[#5be1a5] max-w-xs w-[9rem] rounded-xl text-center bg-[#d6f7e7] py-2 px-2 text-xl font-semibold flex gap-2 items-center mt-10">
